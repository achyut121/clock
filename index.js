...
function addText() {
    ...
    if((vald1 == hours) && (myvald1 == ampm)){
        ...
        `<img src="./wakeup_image.svg" alt="" srcset="" id="changeproperty">`;
        ...
        document.getElementById("image").innerHTML = 
        `<img src="./lunch_image.svg" alt="" srcset="" id="changeproperty" >`;
    }
    else if((vald3 == hours) && (myvald3 == ampm)){
        document.getElementById("wish").innerHTML = "GOOD NIGHT!!!";
        document.getElementById("image").innerHTML = 
        `<img src="./goodnight_image.svg" alt="" srcset="" id="changeproperty" >`;
        document.getElementById("message").innerHTML = "IT'S TIME TO SLEEP!";   
    }
    else{
        document.getElementById("wish").innerHTML = "Please set the time...";
        document.getElementById("image").innerHTML = 
        `<img src="./default.jpg" alt="" srcset="" id="changeproperty" >`;
        document.getElementById("message").innerHTML = "Default Time";
    }
...
function realTime() {
    if(isTrue == true){
        ...
        if((hours>=4) && (hours<12) && (ampm=="AM")){
            document.getElementById("message").innerHTML = "LET'S HAVE BREAKFAST";
            document.getElementById("image").innerHTML = `<img src="./wakeup_image.svg" alt="" id="changeproperty" >`;
            document.getElementById("wish").innerHTML = "Good morning!!!";
        }
        else if ((hours>=12) && (ampm == "PM") || (hours < 4) ) {
            document.getElementById("message").innerHTML = "LET'S HAVE LUNCH";
            document.getElementById("image").innerHTML = `<img src="./lunch_image.svg" alt="" id="changeproperty">`;
            document.getElementById("wish").innerHTML = "GOOD AFTERNOON!!!";
        }
        else if ((hours>=4) && (hours<=11) && (ampm=="PM")) {
            document.getElementById("message").innerHTML = "LET'S HAVE DINNER";
            document.getElementById("image").innerHTML = `<img src="./goodnight_image.svg" alt="" id="changeproperty">`;
